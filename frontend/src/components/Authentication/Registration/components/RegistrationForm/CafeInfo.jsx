      ...
      <div className='grid grid-cols-1 gap-y-3 gap-x-6'>
        <div className="flex flex-col items-center justify-center mb-6">
          <div
            ...
            className="w-24 h-24 rounded-full bg-gray-100 border-2 border-dashed border-gray-300 flex flex-col items-center justify-center cursor-pointer hover:bg-gray-50 transition-colors mb-2 overflow-hidden"
          >
            {logoPreview ? (
              <img
