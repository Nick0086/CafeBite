...
export default function ImageViewerModal({ isOpen, onClose, images, currentImageIndex, setCurrentImageIndex }) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent showClose={false} className="max-w-5xl p-0 z-[9999] overflow-hidden" stopOutsideClick={true}>
