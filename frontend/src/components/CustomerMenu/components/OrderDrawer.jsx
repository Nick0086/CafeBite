                ...
                <div className="flex items-center justify-between">
                    <div className="flex-1">
                        ...
                        <div className='flex items-center gap-1'>
                            ...
                            <p className="text-sm text-primary">({currencySymbol} {lineTotal})</p>
                        </div>
                    </div>
...
export const OrderDrawer = ({ currencySymbol }) => {
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                                {orderCount} items · {currencySymbol} {total.toFixed(2)}
                            </p>
                        </div>
                    </div>
                </Card>
...
function OrderItemRow({ item, currencySymbol }) {
