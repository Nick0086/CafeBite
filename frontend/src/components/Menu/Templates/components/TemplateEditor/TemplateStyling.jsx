...
import { templateDefaultValue, DEFAULT_SECTION_THEME } from '../../constants/template.constants';
...
const TemplateStyling = ({ templateConfig, isLoading, setTemplateConfig, currentSection }) => {
