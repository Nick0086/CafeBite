...
import { DEFAULT_SECTION_THEME } from '../../constants/template.constants';
...
export default function TemplateMenuViewerLayout({ templateConfig, setCurrenctCategoryItems }) {
    ...
    return (
        <div className="p-4 max-h-[calc(100dvh-48px)] min-h-[calc(100dvh-48px)] overflow-auto" style={containerStyle}>
            <Accordion
                type="multiple"
